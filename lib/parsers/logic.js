...
=======
    {regex:/[a-zA-Z][\-a-zA-Z0-9_.]*/, token:'name'}, // Changed this by adding dot
>>>>>>> 0aca34ee0fe325efb96db2644c2154e4fa534d7a
  ...
  // Changed this
  // Transforms property identifiers into dot notation (Q.a.b.c) or bracket lookups
...
<<<<<<< HEAD
      var parts = sequence[0].text.split('.');
      var result = "Q['" + parts.join("']['") + "']";
      return [result];
=======
      return [transformIdentifier(sequence[0].text)];
>>>>>>> 0aca34ee0fe325efb96db2644c2154e4fa534d7a
    }),
